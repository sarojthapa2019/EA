...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        List<Airline> airlines = em.createQuery("select distinct a from Airline a Join a.flights f Join f.airplane ap where ap.model like 'A380' ", Airline.class).getResultList();
        ...
        flights = em.createQuery("select f from Flight f Join f.airplane ap Join f.airline al Where ap.model like '747' and al.name not like 'Star Alliance'", Flight.class).getResultList();
        System.out.printf("%-9s%-31s%-31s\n", "Flight:", "Departs:",
                "Arrives:");
        for (Flight flight : flights) {
            System.out.printf("%-7s  %-12s %7s %8s  %-12s %7s %8s\n",
        ...
        TypedQuery<Flight> query = em.createQuery("from Flight f Where f.departureDate = '2009-08-07' and f.departureTime<'12:00:00'", Flight.class);
